...
import styles from "../../styles/admin/editPlaceStyles";
...
handleMapPress,
handleSubmit,
getDisplayImage} = useEditPlace(navigation,route);
  if (loadingTypes || loadingLieu) {
    return (
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Image du lieu</Text>
          ...
          <View style={styles.imageContainer}>
            ...
            <View style={styles.imageButtonsContainer}>
              ...
              {(currentImage || newImageUri) && !removingImage && (
                <TouchableOpacity
          ...
          {(removingImage || newImageUri === "") && (
            <Text style={styles.imageNote}>
              L'image sera remplacée par l'image par défaut après la sauvegarde
            </Text>
          )}
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            ...
            <Text style={styles.sectionSubtitle}>
              {" "}
              (cliquez pour déplacer le marqueur)
            </Text>
          </Text>
